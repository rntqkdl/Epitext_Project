# -*- coding: utf-8 -*-
"""
번역에 사용되는 시스템 프롬프트와 퓨샷 예제를 관리하는 파일입니다.
"""
...
<example>
<input>觀察使閔公致序 永世不忘碑 歉嶎耀政 以竪尾石 民色俱便 頌德百年</input>

<output>

[음독]: 관찰사민공치서영세불망비겸위요정이수미석민색구편송덕백년

[고유명사 추출]: 관찰사(觀察使), 민공(閔公), 치서(致序), 영세불망비(永世不忘碑)

[최종 번역]: 관찰사(觀察使) 민치서(閔致序) 영세불망비(永世不忘碑). 빛나고 우뚝한 정사는 작은 비석을 세워 기록하였네. 백성과 만물이 모두 편안하니 백년토록 공덕을 칭송하네.
