# 1. 수정할 파일 경로 설정 (사용자님 경로에 맞춤)$targetPath = "1_data/crawlers/pdf_processing/README.md"# 2. 올바른 마크다운 내용 정의$readmeContent = @'
...
# 기본 사용법cd 1_data/crawlers/pdf_processing

python main.py --input "PDF파일_경로" --output "저장할_경로"# 예시 (Windows)
...
[System.IO.File]::WriteAllText("$PWD/$targetPath", $readmeContent, [System.Text.Encoding]::UTF8)
